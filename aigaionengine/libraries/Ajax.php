...
class Scriptaculous extends Prototype {
	...
	function auto_complete_field($field_id,$options)
  {
		...
		$js_options=array();
		if (isset($options['tokens']))$js_options['tokens']=$this->_array_or_string_for_javascript($options['tokens']);
		...
		foreach (array('on_show'=>'onShow','on_hide'=>'onHide','min_chars'=>'minChars') as $var => $val)
    {
